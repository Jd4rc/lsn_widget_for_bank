...
@pytest.fixture
def base_transactions_in_without_currency():
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture
def base_transactions_in_another_type_of_data():
    return (
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture
def base_transactions_in_without_descriptions():
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
